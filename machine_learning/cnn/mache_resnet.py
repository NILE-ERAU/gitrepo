# Usage:
# python mache_resnet.py -d ../dataset/ -m resnet_model.hdf5
...
# train the network over 60 epochs (try 30 - 40 epochs)
# print("[INFO] training network...")
H = model.fit_generator(aug.flow(trainX, trainY, batch_size=128),
